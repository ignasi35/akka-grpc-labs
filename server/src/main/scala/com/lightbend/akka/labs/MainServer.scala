...
object MainServer  {
  ...
  private def serverHttpContext(): HttpsConnectionContext = {
    ...
    val keyEncoded = read(MainServer.getClass.getResourceAsStream("/certs/server1.key"))
    ...
    val cer = fact.generateCertificate(MainServer.getClass.getResourceAsStream("/certs/server1.pem"))
